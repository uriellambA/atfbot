...
const SANCTION_REASONS_DATA = [
    { label: "Tarjeta roja",                               tipo: "Tarjeta Roja",   duration: "1 GW",        price: 75,  gw: 1    },
    { label: "Doble amarilla = Roja",                       tipo: "Tarjeta Roja",   duration: "1 GW",        price: 75,  gw: 1    },
    { label: "GIF NSFW",                                    tipo: "Sanción Severa",  duration: "7 GW",        price: 1500,  gw: 7    },
    { label: "Gore",                                        tipo: "Sanción Grave",  duration: "7 GW",        price: 1500,  gw: 7    },
    { label: "Filtrar la cara de un usuario sin consentimiento", tipo: "Sanción Grave",  duration: "1 Season",        price: 2500,  gw: null    },
    { label: "Filtrar información privada de un miembro de ATF", tipo: "Sanción Grave",  duration: "2 Season",        price: 5000,  gw: null    },
    { label: "Jugar un partido sin estar fichado",          tipo: "Sanción Leve",   duration: "2 GW",        price: 150,  gw: 2    },
    { label: "Pasar por 3 equipos en una temporada",        tipo: "Sanción Leve",   duration: "5 GW",        price: 350,  gw: 5    },
    { label: "Evadir un PC CHECK",                          tipo: "Sanción Severa",   duration: "1 Season",        price: 2500,  gw: null    },
    { label: "Ser cómplice de actividades sancionables",    tipo: "Sanción Severa",   duration: "7 GW",        price: 1500,  gw: 7    },
    { label: "Mala administración del club",                tipo: "Sanción Media",  duration: "5 GW",        price: 750,  gw: 5    },
    ...
    { label: "Corrupción siendo moderador",                 tipo: "Sanción Severa", duration: "5 GW",    price: 750, gw: 5 },
    { label: "Falsificación de documentos",                 tipo: "Sanción Severa", duration: "1 Season",    price: 2500, gw: null },
    { label: "Alting",                                      tipo: "Sanción Severa", duration: "1 Season",    price: 1500, gw: null },
    { label: "ACC Share",                                   tipo: "Sanción Severa", duration: "1 Season",    price: 1500, gw: null },
    { label: "Intento de raid",                             tipo: "Sanción Grave", duration: "3 Season",    price: 7500, gw: null },
    ...
    { label: "Disband",                                     tipo: "Sanción Grave", duration: "1 Season", price: 2500, gw: null },
];
